...
CREATE TABLE `homework_5`.`orders` (
...
INSERT INTO `homework_5`.`orders` (`OrderID`,`CustomerID`,`EmployeeID`,`OrderDate`,`ShipperID`)
VALUES
...
CREATE TABLE `homework_5`.`products` (
...
INSERT INTO `homework_5`.`products` (`ProductID`,`ProductName`,`SupplierID`,`CategoryID`,`Unit`,`Price`)
VALUES
...
CREATE TABLE `homework_5`.`orderdetails` (
...
INSERT INTO `homework_5`.`orderdetails` (`OrderDetailID`,`OrderID`,`ProductID`,`Quantity`)
VALUES
(1,10248,11,12),
(2,10248,42,10),
(3,10248,72,5),
